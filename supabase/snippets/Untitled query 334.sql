CREATE OR REPLACE FUNCTION public.build_token_draft(
  ...
  p_logo_url             text      DEFAULT NULL,   -- ← added
...
REVOKE ALL    ON FUNCTION public.build_token_draft(uuid,uuid,text,text,text,text,smallint,text,numeric,text,text,text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.build_token_draft(uuid,uuid,text,text,text,text,smallint,text,numeric,text,text,text) TO authenticated;
