DROP FUNCTION IF EXISTS public.build_token_draft(uuid,uuid,text,text,text,text,smallint,text,numeric,text,text,text);
...
BEGIN
  ...
  VALUES (
    ...
    p_logo_url,
    p_tiktok_url,          -- ← added
    p_instagram_url,       -- ← added
    p_discord_url,         -- ← added
    p_communities_url,     -- ← added
    p_decimals,
    p_token_type,
    p_max_supply,
    p_metadata_uri,
...
REVOKE ALL    ON FUNCTION public.build_token_draft(uuid,uuid,text,text,text,text,text,text,text,text,smallint,text,numeric,text,text,text) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.build_token_draft(uuid,uuid,text,text,text,text,text,text,text,text,smallint,text,numeric,text,text,text) TO authenticated;